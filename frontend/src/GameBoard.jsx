...
const endges = [[1, 3], [0, 2, 4], [1, 14], [4, 10], [1, 3, 5, 7], [4, 13], [7, 11], [4, 6, 8], [7, 12], [0, 10, 21], [3, 9, 11, 18], [6, 10, 15], [8, 13, 17], [5, 12, 14, 20], [2, 13, 23], [11, 16], [15, 17, 19], [12, 16], [10, 19], [16, 18, 20, 22], [13, 19], [9, 22], [19, 21, 23], [14, 22]]
...
const GameBoard = ({ players, setPlayers }) => {
    ...
    const populatePosibleMoves = (data, index) => {
        ...
        var points_to_highlight = endges[index].filter((p) => {
    ...
    const populatePosiblePlayerRemove = (isRevert) => {
        ...
        const findAllTriplets = (playerState) => {
            ...
            for (let row = 0; row <= 6; row++) {
                ...
                for (let i = 0; i <= rowElements.length - 3; i++) {
            ...
            for (let col = 0; col <= 6; col++) {
                ...
                for (let i = 0; i <= colElements.length - 3; i++) {
